...
dataobj *execute (int *instruction, dataobj * consts, int code_size,
		  dataobj * varind, dataobj * namind, dataobj * globnames);
...
{
  enum
  { is_int, is_code, is_string, is_null, is_none, is_false, is_true } type;
  union
  {
    int ival;
    codeobj *codedat;
